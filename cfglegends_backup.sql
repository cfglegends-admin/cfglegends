...
\restrict vdgji8DzgvqHLL66uMLquqRSdeJnvz4XJVi8gi9RzontMFej8tGBASjKQLYYG0j
...
--
-- Name: admin_audit_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.admin_audit_logs_id_seq OWNER TO neondb_owner;

--
-- Name: admin_audit_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: limited_cards; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.limited_cards OWNER TO neondb_owner;

--
-- Name: limited_cards_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.limited_cards_id_seq OWNER TO neondb_owner;

--
-- Name: limited_cards_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: admin_audit_logs id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: limited_cards id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
--
-- Data for Name: limited_cards; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--
...
--
-- Name: admin_audit_logs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: limited_cards_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: cards cards_card_number_unique; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: limited_cards limited_cards_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: admin_users_email_unique; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: admin_audit_logs admin_audit_logs_admin_user_id_admin_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
\unrestrict vdgji8DzgvqHLL66uMLquqRSdeJnvz4XJVi8gi9RzontMFej8tGBASjKQLYYG0j
